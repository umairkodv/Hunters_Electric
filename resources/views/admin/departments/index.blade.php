                    ...
                    <tr class="hover:bg-[#f8fafc]/60 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right align-middle select-none">
                            <div class="flex items-center justify-end gap-2.5">
                                ...
                                <form action="{{ route('admin.departments.destroy', $department) }}" method="POST" class="inline" onsubmit="return confirm('Delete this department and everything under it? This cannot be undone.');">
                                    @csrf
                                    @method('DELETE')
