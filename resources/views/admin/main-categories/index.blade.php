<x-admin-layout title="Main Categories">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('admin.main-categories.create') }}"
            ...
            <tbody class="divide-y divide-gray-100">
                @forelse ($mainCategories as $mainCategory)
                    <tr class="hover:bg-[#f8fafc]/60 transition-colors">
                        ...
                        <td class="px-6 py-4 text-xs font-semibold text-gray-500">{{ $mainCategory->department->name }}
                        </td>
                        ...
                        <td class="px-6 py-4 text-xs font-semibold text-gray-500">
                            {{ $mainCategory->subcategories_count }}</td>
