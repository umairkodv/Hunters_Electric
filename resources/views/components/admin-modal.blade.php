...
<div id="{{ $id }}" class="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs select-none antialiased">
    ...
    <div class="relative w-full max-w-lg max-h-[calc(100vh-2rem)] bg-white border border-gray-200 rounded-2xl shadow-xl overflow-hidden text-left flex flex-col transform scale-100 transition-all duration-200">
        ...
        <!-- ======================================================== -->
        <form action="{{ $actionRoute }}" method="POST" class="flex flex-col grow overflow-hidden m-0">
            @csrf
