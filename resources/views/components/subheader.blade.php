...
<div class="relative bg-white border-b border-gray-200 w-full px-12 flex items-center justify-between shadow-sm">
    ...
    <div class="relative inline-block group">
        ...
        <!-- UPDATED: Changed text-gray-600 to text-nav-text, hover:text-red-500 to group-hover:text-accent -->
        <a href="#" class="text-xs uppercase font-semibold text-nav-text group-hover:text-accent tracking-wider py-5 flex items-center gap-1">
            ...
            <!-- UPDATED: Changed group-hover:text-red-500 to group-hover:text-accent -->
        ...
        <!-- UPDATED: Changed text-gray-800 to text-nav-text -->
        <div class="absolute right-0 top-full w-[340px] bg-white text-nav-text shadow-xl border border-gray-200 z-50 invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-all duration-150 pointer-events-none group-hover:pointer-events-auto p-6">
            ...
            <div class="flex items-start gap-4 mb-4">
                ...
                <!-- UPDATED: Changed bg-red-600 to bg-accent -->
                ...
                <div class="flex flex-col">
                    <!-- UPDATED: Changed text-gray-800 to text-nav-text, hover:text-red-500 to hover:text-accent -->
            ...
            <!-- UPDATED: Changed text-gray-600 to text-nav-subtext, hover:text-red-500 to hover:text-accent across all links -->
