            ...
            <tbody class="divide-y divide-gray-100">
                <?php $__empty_1 = true; $__currentLoopData = $quotations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quotation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-[#f8fafc]/60 transition-colors">
                        <td class="px-6 py-4 text-xs font-black text-nav-text">#<?php echo e($quotation->id); ?></td>
                        <td class="px-6 py-4">
...
<?php endif; ?></td>
                        ...
                        <td class="px-6 py-4 text-right">
                            <a href="<?php echo e(route('admin.quotations.show', $quotation)); ?>" class="inline-flex items-center justify-center px-3 py-1.5 rounded-lg bg-accent/10 hover:bg-accent text-accent hover:text-white text-[11px] font-black uppercase tracking-wider transition-all duration-150">
                                Review
                            </a>
                        </td>
                    </tr>
...
<?php endif; ?>
<?php /**PATH C:\Users\kk\Downloads\Hunters_Electric_Phase7_3\resources\views/admin/quotations/index.blade.php ENDPATH**/ ?>