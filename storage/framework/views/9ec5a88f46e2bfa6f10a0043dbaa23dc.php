        ...
        <div class="max-w-5xl mx-auto px-6 sm:px-12 flex flex-col gap-8">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl shadow-2xs overflow-hidden">
                ...
                <div class="px-8 py-6 bg-gray-50/30 border-t border-gray-100">
                    <a href="<?php echo e(route('quote.start', $product)); ?>" class="inline-flex items-center gap-2 bg-accent text-white text-xs font-black uppercase tracking-widest px-6 py-3 rounded-lg hover:bg-accent-hover transition-colors">
                        Request a Quote
                    </a>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\kk\Downloads\Hunters_Electric_Phase6_2\resources\views/product.blade.php ENDPATH**/ ?>