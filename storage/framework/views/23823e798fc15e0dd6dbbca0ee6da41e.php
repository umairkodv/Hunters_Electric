                                ...
                                <tr class="hover:bg-[#f8fafc]/60 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <img src="<?php echo e($product->display_image_url); ?>" alt="<?php echo e($product->part_number); ?>" class="h-10 w-10 object-contain bg-gray-50 border border-gray-200 rounded-lg p-1 shrink-0">
                                            <div>
...
<?php endif; ?>
<?php /**PATH C:\Laravel\Hunters_Electric\resources\views/cart.blade.php ENDPATH**/ ?>