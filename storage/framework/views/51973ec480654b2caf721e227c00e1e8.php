...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.part-image','data' => ['url' => $imageUrl,'alt' => $name,'class' => 'max-h-full max-w-full object-contain transform transition-transform duration-200 group-hover:scale-105']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($imageUrl),'alt' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($name),'class' => 'max-h-full max-w-full object-contain transform transition-transform duration-200 group-hover:scale-105']); ?>
