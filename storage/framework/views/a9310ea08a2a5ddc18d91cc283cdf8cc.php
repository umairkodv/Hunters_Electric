                                ...
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-[#f8fafc]/60 transition-colors">
                                        <td class="px-6 py-4 w-24">
                                            <a href="<?php echo e(route('product.show', [$product->subcategory->mainCategory->department->slug, $product->subcategory->mainCategory->slug, $product->subcategory->slug, $product->part_number])); ?>" class="inline-block">
...
<?php endif; ?>
<?php /**PATH C:\Laravel\Hunters_Electric\resources\views/search.blade.php ENDPATH**/ ?>