...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['sectionTitle', 'featuredImage', 'categories' => []]));
...
foreach (array_filter((['sectionTitle', 'featuredImage', 'categories' => []]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php /**PATH C:\Users\kk\Downloads\Hunters_Electric_Phase2_1\resources\views/components/product-section.blade.php ENDPATH**/ ?>