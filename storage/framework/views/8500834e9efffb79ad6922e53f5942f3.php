    ...
    <div class="w-full bg-[#f8fafc] min-h-screen py-12 border-t border-gray-100 select-none antialiased">
        <div class="max-w-5xl mx-auto px-6 sm:px-12 flex flex-col gap-8">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl shadow-2xs p-6">
                ...
                <a href="<?php echo e(route('account.quotations.index')); ?>" class="text-xs font-black uppercase tracking-widest text-accent hover:text-accent-hover transition-colors">
                    View My Quotes &rarr;
                </a>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\kk\Downloads\Hunters_Electric_Phase7\resources\views/account/dashboard.blade.php ENDPATH**/ ?>