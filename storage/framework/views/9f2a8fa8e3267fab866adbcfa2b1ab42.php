...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-layout','data' => ['title' => 'Edit Product']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['title' => 'Edit Product']); ?>
    <div class="max-w-lg bg-white border border-gray-200 rounded-2xl shadow-2xs p-6">
        <form action="<?php echo e(route('admin.products.update', $product)); ?>" method="POST" class="flex flex-col gap-4">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <select name="subcategory_id" required
                    ...
                    <?php $__currentLoopData = $subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($subcategory->id); ?>" <?php if(old('subcategory_id', $product->subcategory_id) == $subcategory->id): echo 'selected'; endif; ?>>
            ...
            <div>
                ...
                <input type="text" name="part_number" value="<?php echo e(old('part_number', $product->part_number)); ?>" required
                       class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-accent focus:border-accent" />
            ...
            <div>
                ...
                <input type="text" name="type_description" value="<?php echo e(old('type_description', $product->type_description)); ?>" required
                       class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-accent focus:border-accent" />
            </div>
            ...
            <div>
                ...
                <textarea name="specifications" rows="4" required
                          class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-accent focus:border-accent"><?php echo e(old('specifications', $product->specifications)); ?></textarea>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="stock_qty" min="0" value="<?php echo e(old('stock_qty', $product->stock_qty)); ?>" required
                           class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-accent focus:border-accent" />
                </div>
            </div>
            ...
            <div>
                ...
                <input type="number" name="price" step="0.01" min="0" value="<?php echo e(old('price', $product->price)); ?>" required
                       class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-accent focus:border-accent" />
            </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\kk\Downloads\Hunters_Electric_Phase4\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>